...
export const guardarCliente = async (req, res) => {
  try {
    ...
    const { nombre, apellido, fecha_nacimiento, num_telefonico, email } = req.body;
    const cliente = await Cliente.create({ nombre, apellido, fecha_nacimiento, num_telefonico, email });
